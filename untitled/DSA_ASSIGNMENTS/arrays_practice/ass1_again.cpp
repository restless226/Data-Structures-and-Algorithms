...
public:
    ...
    void linear_srch() {
        ...
        for (i = 0; i <= total; i++) {
            if (srch == s[i].sgpa) {
                cout << "Name :- " << s[i].name << ", Roll number :-  " << s[i].number << ", sgpa :- " << s[i].sgpa
                     << endl;
    ...
    void bin_srch() {
        ...
        while (beg <= end) {
            ...
            if (srch.compare(s[mid].name) == 0) {
                cout << "Name :- " << s[mid].name << ", Roll number :-  " << s[mid].number << ", sgpa :- "
                     << s[mid].sgpa
                     << endl;
                break;
            }
...
int main() {
    ...
    cout
            << "Press 1) Sort roll numbers. 2) Sort alphabetically, 3) Sort with sgpa. 4) Search student with sgpa. 5) Search student with name. 9) Terminate"
            << endl;
