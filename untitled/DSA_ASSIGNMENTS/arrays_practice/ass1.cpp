...
//{
//    int num;
//    cout<<"Enter the number of students for which you want to create this database(maximum 15 students allowed): "<<endl;
//    cin>>num;
...
//                if(count>=15)
//                {
//                    cout<<"There are already 15 students in the database!! Sorry, You cannot add more students!!"<<endl;
//                    break;
//                }
//                else{
//                    s.addEntry();
