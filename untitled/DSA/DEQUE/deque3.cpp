 ...
 * it uses 'individual allocated fixed size array' , with index based access to DEQUE
 * it performs 'two-pointer dereference' unlike 'one-pointer dereference' in vector
 * storage of DEQUE is automatically expanded and contracted as needed
 ...
 * incase of DEQUE, we will just append a new array into DEQUE, and we are not copying
   any elements
